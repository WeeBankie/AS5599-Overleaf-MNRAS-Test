...
Based on the very poor conclusions arrived at in Section \ref{sec:conclusions} we need to do lots more work.
...
\bibliography{jpnewbib1,JPbib2018} % if your bibtex file is called example.bib
%\bibliography{JPbib2018} % if your bibtex file is called example.bib
